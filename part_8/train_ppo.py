...
def main():
    ...
    while step < args.steps:
        ...
        # logprobs and values for policy and reference
        # model_logprobs returns (B, T-1) for next_token logp; align to seq[:, 1:]
        ...
        with torch.no_grad():
            ...
            lp_now = lp_post                             # already computed above the same positions
            kl_ref_now = (lp_now - ref_logp).mean()            # ≈ E[log π_new - log π_ref]
