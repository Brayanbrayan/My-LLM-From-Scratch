...
if __name__ == "__main__":
    ...
    if args.demo:
        ...
        run("python train_sft.py --data huggingface --ckpt ../part 4/runs/part4-demo/model_last.pt --out runs/sft-demo --steps 300 --batch_size 8 --block_size 256 --n_layer 2 --n_head 2 --n_embd 128")
