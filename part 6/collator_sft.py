...
sys.path.append(str(_P(__file__).resolve().parents[1]/'part 4'))
try:
...
class SFTCollator:
    ...
    def __init__(self, block_size: int = 256, bpe_dir: str | None = None):
        ...
        if _HAS_BPE:
            ...
            try:
                ...
                if bpe_dir:
                    ...
                    # Weak ad-hoc training would belong elsewhere; for the demo we assume Part tokenizer exists
                    pass
            except Exception:
        ...
        if self.tok is None:
            raise RuntimeError("No tokenizer available. Install tokenizers or ensure Part ByteTokenizer exists")
