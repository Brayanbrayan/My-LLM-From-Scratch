...
# If policy.py is being run alone, it needs its own path setup
part3_path = str(Path(__file__).resolve().parents[1] / 'part_3')
if part3_path not in sys.path:
    sys.path.append(part3_path)

# Direct import since part_3 is in sys.path
